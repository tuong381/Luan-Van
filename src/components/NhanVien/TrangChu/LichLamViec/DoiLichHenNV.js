...
const DoiLichHenNV = ({route, navigation}) => {
    ...
    fetch(URL.localhost + '/App_API/NhanVien/LichLamViec/DoiLichNV.php', {
      ...
      .then(responseJson => {
        ...
        if (responseJson.id == 0) {
          Alert.alert('Warning!', `Vui lòng chọn lại giờ do nhân viên bận !`);
        } else {
          Alert.alert(
            'Thông báo!',
